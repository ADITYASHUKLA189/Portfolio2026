      ...
      .then(
        ...
        (error) => {
          ...
          if (toastMountedRef.current) {
            setIsSent(false);
            setIsDisabled(false);
            addToast(`EmailJS: ${errMsg}`, "error");
            setTimeout(() => {
              if (toastMountedRef.current) setIsSent(null);
            }, 30000);
          }
        },
      );
        ...
        >
          <div className="contact-container">
            <div className="contact-div">
              ...
              >
                Email:{" "}
                <a href="mailto:Shukladitya22@gmail.com" className="lead">
                  Shukladitya22@gmail.com
                </a>
              </motion.h5>
              <motion.h5
                className="contact-info"
              ...
              >
                Address:{" "}
                <span className="lead">
                  IIIT Bhubaneswar, Gothapatna, Bhubaneswar, Odisha
                </span>
              </motion.h5>
              <br />
              <motion.h5
