...
describe("NavBar", () => {
  ...
  it("renders brand Aditya Shukla", () => {
  ...
  it("calls addTab with FeedTab when FEED link is clicked", () => {
    ...
    if (feedLink) {
      ...
      expect(mockAddTab).toHaveBeenCalledWith("FeedTab", { title: "Aditya's Feed" });
    } else {
  ...
  it("calls addTab with AIChatTab when AI companion link is clicked", () => {
    ...
    expect(mockAddTab).toHaveBeenCalledWith("AIChatTab", { title: "Aditya's AI Companion" });
  });
