...
const Footer = ({ isBatterySavingOn, addTab }) => {
  const linksData = [
    ...
    {
      href: "https://www.linkedin.com/in/aditya-shukla-44121a2bb/",
    ...
    {
      href: "mailto:Shukladitya22@gmail.com",
  ...
  return (
    ...
    >
      ...
      >
        <h2>Aditya Shukla</h2>
        <p>Aspiring Software Engineer | B.Tech IT @ IIIT-Bhubaneswar</p>
      </motion.div>
      ...
      >
        <p>
          &copy; {new Date().getFullYear()} Aditya Shukla. All rights reserved.
        </p>
      </motion.div>
    </motion.footer>
  );
