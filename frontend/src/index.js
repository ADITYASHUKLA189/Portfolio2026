...
const MODAL_SEGMENTS = {
  feed: { type: "FeedTab", data: { title: "Aditya's Feed" } },
  feeds: { type: "FeedTab", data: { title: "Aditya's Feed" } },
  admin: { type: "Admin", data: { adminTitle: "Admin Page" } },
  dashboard: { type: "Admin", data: { adminTitle: "Admin Page" } },
  ai: { type: "AIChatTab", data: { title: "Aditya's AI Companion" } },
  aichat: { type: "AIChatTab", data: { title: "Aditya's AI Companion" } },
  chat: { type: "AIChatTab", data: { title: "Aditya's AI Companion" } },
};
